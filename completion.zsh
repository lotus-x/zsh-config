...
fpath+=$ZSH_CONFIG_DIR/plugins/ohmyzsh/plugins/extract
fpath+=$ZSH_CONFIG_DIR/plugins/ohmyzsh/plugins/flutter
fpath+=$ZSH_CONFIG_DIR/plugins/ohmyzsh/plugins/adb
...
# See $ZSH_CONFIG_DIR/zsh/scripts.zsh
compdef vman="man"
...
## For kubernetes
# source $ZSH_CONFIG_DIR/zsh/plugins/kubectl-completion/_kubectl
